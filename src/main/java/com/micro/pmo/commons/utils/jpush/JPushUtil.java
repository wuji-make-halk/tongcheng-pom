...
/**
 * @Author: raobo
 * @Description: 极光推送,暂时不使用
 * @Date: Created in 16:35 2019/8/13
 */
//@Component
public class JPushUtil {
    ...
    private final static String appKey = "c08db16450be85f557e6c52b";
 
    private final static String masterSecret = "fd592fe0c3d8ae67f967accc";
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAliasList(List<String> aliasList, String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
	 ...
	 public static void main(String[] args) {
		 try {
		    	...
		    	josn.addProperty("id", 71);
			 List<String> aliasList = new ArrayList<String>();
			 aliasList.add("thhcAlias");
			 sendToAliasList(aliasList, title, text, text, josn.toString());
	        } catch (Exception e) {
	        	LOGGER.info("推送异常");
	            e.printStackTrace();
	        }
